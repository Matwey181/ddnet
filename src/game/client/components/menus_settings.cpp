...
// Pushin client — Var list: implementation moved to menus_settings_pushin.cpp
// to keep this file manageable. The function is declared in menus.h and
// the new file provides the body. See MEMORY.md and AGENT_MEMORY note at
